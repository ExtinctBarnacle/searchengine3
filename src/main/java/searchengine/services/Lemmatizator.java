...
public class Lemmatizator {
    ...
    public static HashMap<String, Integer> getWordsCount(String text) throws IOException {
        ...
        for (String i : textArray) {
            ...
            List<String> wordBaseForms = luceneMorph.getNormalForms(i);
           // wordBaseForms.forEach(System.out::println);
            ...
            if (splittedWordInfo[1].equals("СОЮЗ")  || splittedWordInfo[1].equals("МЕЖД") || splittedWordInfo[1].equals("ПРЕДЛ")){continue;}
            Integer wordCount = words.get(wordBaseForms.get(0));
            if (wordCount == null) {wordCount = 1;} else {wordCount++;}
